...
function TodoList({
  ...
  // State for toggling the add todo section visibility
  ...
  // Toggle function for the add section
  ...
  return (
    <div className="w-full bg-white p-4 rounded-lg shadow-md">
      ...
      <div className="bg-teal-100 shadow-md rounded-lg p-3 mb-4">
        {/* Main container with responsive flex direction */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          {/* List name and counter section */}
      ...
      <div
        className="flex items-center justify-between mb-3 bg-gray-100 p-2 rounded-lg cursor-pointer"
        onClick={toggleAddSection}
      >
        <h3 className="text-lg font-medium">Todo Ekleme</h3>
      ...
      {/* Add section that can be toggled */}
      {showAddSection && (
        <div className="mb-6">
