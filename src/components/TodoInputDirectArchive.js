...
const TodoInputDirectArchive = ({
  ...
  const MAIN_INPUT_ID = "main-archive-input";
  ...
  const isFormValid = () => {
    // Required fields: value, newTodoCategory, amount, unit, selectedStore, newTodoPrice
    return (
      value.trim() !== "" &&
      newTodoCategory !== "" &&
      amount !== "" &&
    ...
    <div className="flex flex-col gap-3 w-full p-4 bg-white shadow-lg rounded-2xl">
          ...
          >
            {suggestionList.map((todo) => (
              <div
                ...
                onClick={(e) => selectSuggestion(e, todo.text)}
              >
                {todo.text}
              </div>
            ))}
      ...
      <div className="flex gap-2">
        ...
        <Input
          ...
          onFocus={() => setActiveInputId('price')}
      ...
      <div className="flex gap-2">
        <select
          ...
          onFocus={() => setActiveInputId('store')}
        ...
        <Input
          ...
          onFocus={() => setActiveInputId('brand')}
          placeholder="Marka?"
          className="border-2 border-gray-300 rounded-xl p-3"
        />
      </div>
